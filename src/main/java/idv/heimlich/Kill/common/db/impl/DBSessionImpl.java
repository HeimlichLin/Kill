...
import idv.heimlich.Kill.common.dao.RowMapList;
import idv.heimlich.Kill.common.dao.TableMapper;
import idv.heimlich.Kill.common.db.IDBSession;
import idv.heimlich.Kill.common.db.sql.SqlCode;
import idv.heimlich.Kill.common.db.sql.SqlObject;
import idv.heimlich.Kill.common.db.sql.SqlWhere;
import idv.heimlich.Kill.common.db.utils.ConnectionUtil;
import idv.heimlich.Kill.common.exception.TxBusinessException;
...
public class DBSessionImpl implements IDBSession {
	...
	public <Po> int insertPo(Po object) {
		GeneralDAOImpl<Po> dao = TableMapper.lookupDAO(object);
